...
**Seed script tự động xóa tất cả data cũ** trước khi tạo data mới. Điều này đảm bảo:
- ✅ Không có conflict với data cũ
- ✅ Clean state mỗi lần seed
...
# 3. Run seed (auto clears & reseeds)
npm run db:seed
